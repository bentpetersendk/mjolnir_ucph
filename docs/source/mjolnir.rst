...
Mjolnir is physically located at one of UCPH datacenters. This means that all the servers included in the Mjolnir cluster are integrated into the UCPH-IT infrastructure with all their security measures applied.
